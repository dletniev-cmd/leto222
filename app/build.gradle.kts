...
dependencies {
    ...
    // Frosted-glass background blur behind the navbar (and any other
    // place we want iOS-style glass). On API 31+ haze uses the real
    // RenderEffect blur; on older devices it gracefully degrades to
    // a translucent tint.
