...
import com.wellness.app.ui.WellnessApp
import com.wellness.app.ui.icons.SolarIconLoader
import com.wellness.app.ui.state.LocalAppState
import com.wellness.app.ui.state.rememberAppState
...
class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // WellnessApplication.onCreate also calls prewarmAll, so on a
        ...
        setContent {
            ...
            CompositionLocalProvider(LocalAppState provides appState) {
                WellnessTheme(mode = appState.themeMode, accent = appState.accent) {
                    Surface(modifier = Modifier.fillMaxSize()) {
                        Box(Modifier.fillMaxSize().background(com.wellness.app.ui.theme.Wellness.colors.bg)) {
                            WellnessApp()
                        }
                    }
                }
